...
// Definitions by: Bret Little <https://github.com/blittle>, VILIC VANE
// <http://vilic.info>, Wayne Maurer <https://github.com/wmaurer>, Umar Nizamani
// <https://github.com/umarniz>, LiJinyao <https://github.com/LiJinyao>
...
export interface Cheerio {
  ...
  css(propertyName: string,
      func: (index: number, value: string) => string): Cheerio;
  css(propertyName: string,
      func: (index: number, value: string) => number): Cheerio;
...
export interface CheerioStatic extends CheerioSelector {
  ...
  parseHTML(data: string, context?: Document, keepScripts?: boolean):
      Document[];
...
interface CheerioAPI extends CheerioSelector, CheerioStatic {
  ...
  load(element: CheerioElement, options?: CheerioOptionsInterface):
      CheerioStatic;
}
